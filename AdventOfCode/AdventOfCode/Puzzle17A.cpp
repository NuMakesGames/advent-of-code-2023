...
namespace Puzzle17A
{
	constexpr int nodesPerPosition = 12;
	...
	void PrintSolution(const std::filesystem::path& inputFile, bool shouldRender)
	{
		...
		// Add target node connected to all bottom right position nodes with cost 0
		...
		// Add source node connected to all top left position nodes with cost 0
